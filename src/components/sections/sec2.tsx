...
function Sec2() {
  return (
    <>
    <div className='h-[90vh] sec2 w-full bg-[#f8f8f8] flex  p-56 py-48 justify-between'>
        ...
        <div className='flex flex-col py-10 sec2b w-[50%] '>
           ...
           <p className='font-thin font-stretch-semi-expanded  '>My approach blends clean UI/UX, smooth animations, and AI-driven enhancements to create products that feel intuitive and responsive.</p>
